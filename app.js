...
// dDAE_1.228 — error overlay: evita blocchi silenziosi su iPhone PWA
...
function showPage(page){
  ...
  // dDAE_1.228: fallback visualizzazione Pulizie
  try{
    if (page === "pulizie"){
...
// --- FIX dDAE_1.228: renderSpese allineato al backend ---
...
// --- FIX dDAE_1.228: delete reale ospiti ---
...
// --- FIX dDAE_1.228: mostra nome ospite ---
(function(){
  const orig = window.renderOspiti;
  if (!orig) return;
  window.renderOspiti = function(){
